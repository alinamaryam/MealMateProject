...
const [sliderIconVisible, setSliderIconVisible] = useState(false);
  ...
  return (<>
    <View style={styles.iphone13ProMax22}>
      <LinearGradient style={[styles.iphone13ProMax22Child, styles.iphone13Bg]} locations={[0,1]} colors={['rgba(81, 232, 241, 0.32)','rgba(49, 186, 194, 0.24)']} />
      <LinearGradient style={[styles.iphone13ProMax22Item, styles.framePosition1]} locations={[0,1]} colors={['rgba(81, 232, 241, 0.32)','rgba(49, 186, 194, 0.24)']} />
      <LinearGradient style={[styles.wrapper, styles.wrapperPosition]} locations={[0,1]} colors={['rgba(81, 232, 241, 0.32)','rgba(49, 186, 194, 0.24)']}>
        <Pressable style={[styles.pressable, styles.iphone13Bg]} onPress={() => navigation.navigate("IPhone13ProMax19")} />
      </LinearGradient>
      <Image style={[styles.iphone13ProMax22Inner, styles.iconLayout]} contentFit="cover" source={require("../assets/ellipse-5.png")} />
      ...
      <LinearGradient style={[styles.iphone13ProMax22Child1, styles.pressable1Layout]} locations={[0,1]} colors={['rgba(81, 232, 241, 0.32)','rgba(49, 186, 194, 0.24)']} />
      <Pressable style={[styles.daily, styles.dailyPosition]} onPress={() => navigation.navigate("IPhone13ProMax14")}>
      ...
      <LinearGradient style={[styles.frame, styles.framePosition]} locations={[0,1]} colors={['rgba(81, 232, 241, 0.32)','rgba(49, 186, 194, 0.24)']}>
        <Pressable style={[styles.pressable, styles.iphone13Bg]} onPress={() => navigation.navigate("IPhone13ProMax20")} />
      </LinearGradient>
      <LinearGradient style={[styles.wrapper1, styles.framePosition]} locations={[0,1]} colors={['rgba(81, 232, 241, 0.32)','rgba(49, 186, 194, 0.24)']}>
        <Pressable style={[styles.pressable, styles.iphone13Bg]} onPress={() => navigation.navigate("IPhone13ProMax23")} />
      </LinearGradient>
      ...
      <Image style={[styles.groupIcon, styles.groupIconPosition]} contentFit="cover" source={require("../assets/group-47.png")} />
      <Text style={[styles.quality, styles.qualityTypo]}>Quality</Text>
      <Text style={[styles.text, styles.textLayout]}>92.56 %</Text>
      <Pressable style={[styles.maskGroup1, styles.framePosition1]} onPress={() => navigation.navigate("IPhone13ProMax21")}>
      ...
      <Text style={[styles.morePositivity, styles.kcal2Position]}>{`More
Positivity`}</Text>
...
export default IPhone13ProMax22;
