...
const [sliderIconVisible, setSliderIconVisible] = useState(false);
  ...
  return (<>
    <View style={styles.iphone13ProMax32}>
      ...
      <LinearGradient style={[styles.iphone13ProMax32Child, styles.iphone13ChildBg]} locations={[0,1]} colors={['rgba(232, 232, 232, 0.32)','rgba(142, 202, 205, 0.24)']} />
      <LinearGradient style={[styles.iphone13ProMax32Item, styles.iphone13ChildBg]} locations={[0,1]} colors={['rgba(232, 232, 232, 0.32)','rgba(142, 202, 205, 0.24)']} />
      <LinearGradient style={[styles.iphone13ProMax32Inner, styles.iphone13ChildBg]} locations={[0,1]} colors={['rgba(232, 232, 232, 0.32)','rgba(142, 202, 205, 0.24)']} />
      ...
      <LinearGradient style={[styles.iphone13ProMax32Child1, styles.iphone13ChildBg]} locations={[0,1]} colors={['rgba(232, 232, 232, 0.32)','rgba(142, 202, 205, 0.24)']} />
...
goals!`}</Text>
      ...
      <LinearGradient style={[styles.iphone13ProMax32Child2, styles.iphone13ChildBg]} locations={[0,1]} colors={['rgba(81, 232, 241, 0.32)','rgba(49, 186, 194, 0.24)']} />
