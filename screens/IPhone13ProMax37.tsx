...
const [sliderIconVisible, setSliderIconVisible] = useState(false);
  ...
  return (<>
    <View style={styles.iphone13ProMax37}>
      ...
      <LinearGradient style={[styles.iphone13ProMax37Child, styles.iphone13Bg]} locations={[0,1]} colors={['rgba(232, 232, 232, 0.32)','rgba(142, 202, 205, 0.24)']} />
      <LinearGradient style={[styles.iphone13ProMax37Item, styles.iphone13Bg]} locations={[0,1]} colors={['rgba(232, 232, 232, 0.32)','rgba(142, 202, 205, 0.24)']} />
      <LinearGradient style={[styles.iphone13ProMax37Inner, styles.iphone13Bg]} locations={[0,1]} colors={['rgba(232, 232, 232, 0.32)','rgba(142, 202, 205, 0.24)']} />
      <LinearGradient style={[styles.rectangleLineargradient, styles.iphone13Bg]} locations={[0,1]} colors={['rgba(232, 232, 232, 0.32)','rgba(142, 202, 205, 0.24)']} />
      <LinearGradient style={[styles.iphone13ProMax37Child1, styles.iphone13ChildPosition]} locations={[0,1]} colors={['rgba(232, 232, 232, 0.32)','rgba(142, 202, 205, 0.24)']} />
...
goals!`}</Text>
      ...
      <LinearGradient style={[styles.iphone13ProMax37Child2, styles.iphone13ChildPosition]} locations={[0,1]} colors={['rgba(81, 232, 241, 0.32)','rgba(49, 186, 194, 0.24)']} />
      <LinearGradient style={styles.wrapper} locations={[0,1]} colors={['rgba(81, 232, 241, 0.32)','rgba(49, 186, 194, 0.24)']}>
        <Pressable style={[styles.pressable, styles.iphone13Bg]} onPress={() => navigation.navigate("IPhone13ProMax38")} />
      </LinearGradient>
