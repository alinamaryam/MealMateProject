...
const [sliderIconVisible, setSliderIconVisible] = useState(false);
  ...
  return (<>
    <View style={styles.iphone13ProMax36}>
      ...
      <LinearGradient style={[styles.iphone13ProMax36Child, styles.iphone13ChildBg]} locations={[0,1]} colors={['rgba(232, 232, 232, 0.32)','rgba(142, 202, 205, 0.24)']} />
      <LinearGradient style={[styles.iphone13ProMax36Item, styles.iphone13ChildBg]} locations={[0,1]} colors={['rgba(232, 232, 232, 0.32)','rgba(142, 202, 205, 0.24)']} />
      <LinearGradient style={[styles.iphone13ProMax36Inner, styles.iphone13ChildBg]} locations={[0,1]} colors={['rgba(232, 232, 232, 0.32)','rgba(142, 202, 205, 0.24)']} />
      <LinearGradient style={[styles.rectangleLineargradient, styles.iphone13ProMax36Child2Position]} locations={[0,1]} colors={['rgba(232, 232, 232, 0.32)','rgba(142, 202, 205, 0.24)']} />
      <LinearGradient style={[styles.iphone13ProMax36Child1, styles.iphone13ChildBg]} locations={[0,1]} colors={['rgba(232, 232, 232, 0.32)','rgba(142, 202, 205, 0.24)']} />
...
goals!`}</Text>
      ...
      <LinearGradient style={[styles.iphone13ProMax36Child2, styles.iphone13ProMax36Child2Position]} locations={[0,1]} colors={['rgba(81, 232, 241, 0.32)','rgba(49, 186, 194, 0.24)']} />
...
const styles = StyleSheet.create({
  ...
  iphone13ProMax36Child2Position: {
    bottom: "36.07%",
    top: "54.32%",
    backgroundColor: "transparent",
    borderRadius: Border.br_xl,
